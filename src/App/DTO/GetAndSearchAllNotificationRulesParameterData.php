...
/**
 * Parameters for getAndSearchAllNotificationRules
 */
class GetAndSearchAllNotificationRulesParameterData
{
    /**
    ...
    /**
     * A comma-separated list of notification rule identifiers. If specified, then only notification rules whose identifier match any of the given identifiers will be regarded. The maximum number of identifiers is 1000.
    ...
    /**
     * If specified, then only notification rules with given trigger event will be regarded.
     * @DTA\Data(subset="query", field="triggerEvent", nullable=true)
    ...
    /**
     * If specified, then only notification rules that include or not include details will be regarded.
     * @DTA\Data(subset="query", field="includeDetails", nullable=true)
